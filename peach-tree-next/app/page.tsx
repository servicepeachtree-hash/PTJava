...
export default async function HomePage() {
  ...
  const [counts, bestSellers, newReleases, discounts] = await Promise.all([
    ...
    <div className="storefront-root">
      ...
      <section className="section wrap">
        ...
        <div className="product-grid">
          {(bestSellers.data ?? []).map((p: any) => <ProductCard key={p.id} product={p} discountPercent={automaticPercentFor(p.id, discounts)} />)}
