...
export default async function AdminUsersPage({ searchParams }: { searchParams: { q?: string; reset_sent?: string; reset_error?: string } }) {
  ...
  return (
    <div>
      ...
      <div className="admin-table-wrap">
        <table>
          <tbody>
            <tr><th>Name</th><th>Email</th><th>Owns</th><th>Grant a product</th><th>Joined</th><th>Status</th><th></th></tr>
            {(users ?? []).map((u: any) => (
              <tr key={u.id}>
                <td>{u.name}</td>
                <td>{u.email}</td>
