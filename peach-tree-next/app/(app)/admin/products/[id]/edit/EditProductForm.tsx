...
import { getAdminPreviewUrl } from '../../upload-actions';
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="admin-card">
        ...
        {product.schematic_path && (
          <>
            <p className="muted" style={{ marginTop: 8 }}>Current: {product.schematic_path}</p>
            <SchematicPreview path={product.schematic_path} getUrl={() => getAdminPreviewUrl(product.schematic_path)} />
          </>
        )}
      </div>
